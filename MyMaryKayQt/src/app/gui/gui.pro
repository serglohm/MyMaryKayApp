...
symbian {
	...
	vendor_info = \
		" " 
	header = "$${LITERAL_HASH}{\"Mary Components\"},(0xE1E604D6),1,0,0,TYPE=SA,RU"
	package.pkg_prerules += vendor_info header
	DEPLOYMENT += package
	DEPLOYMENT.installer_header = "$${LITERAL_HASH}{\"Mary Installer\"},(0x2002CCCF),1,0,0"
